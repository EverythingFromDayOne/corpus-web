                    ...
                    {items.map((article) => {
                      const kindClass =
                        article.kind === 'concept'
                          ? 'tag-soon ls-tag-concept'
                          : 'tag-soon ls-tag-recipe';
                      const kindLabel =
                        article.kind === 'concept'
                      ...
                      return (
                        <li key={article.uid} className="group relative">
                          ...
                          <a
                            ...
                            className="ls-blog-card relative block rounded-md border p-4 pl-5 no-underline transition-[transform,box-shadow,border-color,background] duration-300 group-hover:-translate-y-0.5"
                          >
