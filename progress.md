...
- **av-rail-scroll-spy (2026-08-26):** TocRail highlight froze one part
  ...
  above the 20% line, with `.av-pnav` / max-scroll forcing the last
  part and 100%. `rootMargin` unchanged. Feature branch PR; not pushed
